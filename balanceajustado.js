function sumard() {
    try {
        ...
        debe22 = parseFloat(document.getElementById("debe22").value) || 0;
        debe23 = parseFloat(document.getElementById("debe23").value) || 0;
        debe24 = parseFloat(document.getElementById("debe24").value) || 0;
        debe25 = parseFloat(document.getElementById("debe25").value) || 0;
        debe26 = parseFloat(document.getElementById("debe26").value) || 0;
        debe27 = parseFloat(document.getElementById("debe27").value) || 0;
        debe28 = parseFloat(document.getElementById("debe28").value) || 0;
        debe29 = parseFloat(document.getElementById("debe29").value) || 0;
        debe30 = parseFloat(document.getElementById("debe30").value) || 0;




        document.getElementById("total2").value = debe + debe1 + debe2 + debe3 + debe4 + debe5 + debe6 + debe7 + debe8 + debe9 + debe10 + debe11 + debe12 + debe13 + debe14 + debe15 + debe16 + debe17 + debe18 + debe19 + debe20 + debe21 + debe22 + debe23 + debe24 + debe25 + debe26 + debe27 + debe28 + debe29 + debe30;
...
function sumarh() {
    try {
        ...
        haber22 = parseFloat(document.getElementById("haber22").value) || 0;
        haber23 = parseFloat(document.getElementById("haber23").value) || 0;
        haber24 = parseFloat(document.getElementById("haber24").value) || 0;
        haber25 = parseFloat(document.getElementById("haber25").value) || 0;
        haber26 = parseFloat(document.getElementById("haber26").value) || 0;
        haber27 = parseFloat(document.getElementById("haber27").value) || 0;
        haber28 = parseFloat(document.getElementById("haber28").value) || 0;
        haber29 = parseFloat(document.getElementById("haber29").value) || 0;
        haber30 = parseFloat(document.getElementById("haber30").value) || 0;




        document.getElementById("total3").value = haber + haber1 + haber2 + haber3 + haber4 + haber5 + haber6 + haber7 + haber8 + haber9 + haber10 + haber11 + haber12 + haber13 + haber14 + haber15 + haber16 + haber17 + haber18 + haber19 + haber20 + haber21 + haber22 + haber23 + haber24 + haber25 + haber26 + haber27 + haber28 + haber29 + haber30;
    ...
    function saveTextAsFile()
    {
        ...
        + document.getElementById("cuenta20").value + ("\r\n") + document.getElementById("cuenta21").value + ("\r\n") + document.getElementById("cuenta22").value + ("\r\n") + document.getElementById("cuenta23").value + ("\r\n")
        + document.getElementById("cuenta24").value + ("\r\n") + document.getElementById("cuenta25").value + ("\r\n") + document.getElementById("cuenta26").value + ("\r\n") + document.getElementById("cuenta27").value + ("\r\n")
        + document.getElementById("cuenta28").value + ("\r\n") + document.getElementById("cuenta29").value + ("\r\n") + document.getElementById("cuenta30").value + ("\r\n")
        ...
        + document.getElementById("debe20").value + ("\r\n") + document.getElementById("debe21").value + ("\r\n") + document.getElementById("debe22").value + ("\r\n") + document.getElementById("debe23").value + ("\r\n")
        + document.getElementById("debe24").value + ("\r\n") + document.getElementById("debe25").value + ("\r\n") + document.getElementById("debe26").value + ("\r\n") + document.getElementById("debe27").value + ("\r\n")
        + document.getElementById("debe28").value + ("\r\n") + document.getElementById("debe29").value + ("\r\n") + document.getElementById("debe30").value + ("\r\n") + document.getElementById("total2").value + ("\r\n")
        ...
        + document.getElementById("haber20").value + ("\r\n") + document.getElementById("haber21").value + ("\r\n") + document.getElementById("haber22").value + ("\r\n") + document.getElementById("haber23").value + ("\r\n")
        + document.getElementById("haber24").value + ("\r\n") + document.getElementById("haber25").value + ("\r\n") + document.getElementById("haber26").value + ("\r\n") + document.getElementById("haber27").value + ("\r\n")
        + document.getElementById("haber28").value + ("\r\n") + document.getElementById("haber29").value + ("\r\n") + document.getElementById("haber30").value + ("\r\n") + document.getElementById("total3").value + ("\r\n");
    ...
    function loadFileAsText()
    {
        ...
        fileReader.onload = function(fileLoadedEvent) 
        {
            ...
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("cuenta22").value = text[22];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("cuenta23").value = text[23];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("cuenta24").value = text[24];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("cuenta25").value = text[25];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("cuenta26").value = text[26];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("cuenta27").value = text[27];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("cuenta28").value = text[28];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("cuenta29").value = text[29];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("cuenta30").value = text[30];



            var textFromFileLoaded = fileLoadedEvent.target.result;
            var text = textFromFileLoaded.split("\n");
            document.getElementById("debe").value = text[31];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe1").value = text[32];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe2").value = text[33];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe3").value = text[34];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe4").value = text[35];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe5").value = text[36];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe6").value = text[37];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe7").value = text[38];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe8").value = text[39];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe9").value = text[40];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe10").value = text[41];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe11").value = text[42];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe12").value = text[43];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe13").value = text[44];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe14").value = text[45];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe15").value = text[46];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe16").value = text[47];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe17").value = text[48];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe18").value = text[49];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe19").value = text[50];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe20").value = text[51];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe21").value = text[52];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe22").value = text[53];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe23").value = text[54];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe24").value = text[55];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe25").value = text[56];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe26").value = text[57];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe27").value = text[58];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe28").value = text[59];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe29").value = text[60];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("debe30").value = text[61];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("total2").value = text[62];
            ...
            var textFromFileLoaded = fileLoadedEvent.target.result;
            var text = textFromFileLoaded.split("\n");
            document.getElementById("haber").value = text[63];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber1").value = text[64];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber2").value = text[65];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber3").value = text[66];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber4").value = text[67];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber5").value = text[68];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber6").value = text[69];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber7").value = text[70];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber8").value = text[71];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber9").value = text[72];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber10").value = text[73];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber11").value = text[74];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber12").value = text[75];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber13").value = text[76];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber14").value = text[77];
        
            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber15").value = text[78];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber16").value = text[79];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber17").value = text[80];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber18").value = text[81];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber19").value = text[82];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber20").value = text[83];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber21").value = text[84];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber22").value = text[85];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber23").value = text[86];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber24").value = text[87];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber25").value = text[88];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber26").value = text[89];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber27").value = text[90];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber28").value = text[91];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber29").value = text[92];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("haber30").value = text[93];

            var textFromFileLoaded = fileLoadedEvent.target.result;
            document.getElementById("total3").value = text[94];
